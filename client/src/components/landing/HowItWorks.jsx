    ...
    <section className="bg-slate-50 py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 md:grid-cols-3">
          ...
          {/* Step 1 */}
          <div className="text-center">
            <FaPlusCircle className="mx-auto text-5xl text-indigo-600" />
          ...
          {/* Step 2 */}
          <div className="text-center">
            <FaColumns className="mx-auto text-5xl text-indigo-600" />
          ...
          {/* Step 3 */}
          <div className="text-center">
            <FaCheckCircle className="mx-auto text-5xl text-indigo-600" />
